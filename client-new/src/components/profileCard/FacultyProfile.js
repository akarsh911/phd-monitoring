...
const FacultyProfile = ({ faculty }) => {
  return (
    <div className="faculty-container">
      ...
      <p className="faculty-sub">{faculty.designation}, {faculty.department}</p>
      ...
      <div className="faculty-info-grid">
        ...
        <div><strong>Supervised (Campus):</strong> {faculty.supervised_campus}</div>
        <div><strong>Supervised (Outside):</strong> {faculty.supervised_outside}</div>
      </div>
