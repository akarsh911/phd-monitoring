	...
	return (
		<>
			...
			<div className="tw-absolute tw-top-0 tw-left-0 tw-w-full tw-h-screen tw-flex tw-items-center tw-justify-center">
				<div className="tw-bg-white tw-w-[100%] tw-max-w-md tw-h-[75%] tw-flex tw-flex-col tw-justify-evenly tw-items-center tw-gap-y-3 max-lg:tw-rounded-lg lg:tw-rounded-tl-lg lg:tw-rounded-bl-lg">
					<img
						src={TIETLogo}
						alt="TIETLogo"
						className="tw-w-[125px] tw-aspect-auto tw-pt-5"
					/>
					<div className="tw-max-w-2xl tw-min-w-[60%] tw-min-h-[60%] tw-max-h-[80%] tw-flex tw-flex-col tw-justify-between tw-items-center tw-pb-5">
						<div className="tw-text-[#525252] tw-font-[inter, sans-serif] tw-font-semibold tw-text-lg">
							Login to your Account
						</div>
						<button className="tw-flex tw-justify-around tw-items-center tw-max-w-lg tw-border-2 tw-border-[#525252b0] tw-rounded-lg tw-gap-2 hover:tw-bg-gray-100">
							<img
								src={googleIcon}
								alt="googleIcon"
						...
						<form className="tw-w-full tw-h-[63%] tw-flex tw-flex-col tw-justify-between tw-items-center">
							...
							<div className="tw-flex tw-justify-between tw-items-center tw-w-full">
								...
								<div className="tw-text-xs tw-text-[#932F2F] hover:tw-underline">
									Forgot Password?
								</div>
							</div>
							<button
								type="submit"
								className="tw-bg-[#932F2F] hover:tw-bg-[#812929] tw-w-10/12 tw-p-2 tw-rounded-md tw-text-white tw-font-semibold"
							>
								Login
							</button>
						</form>
				...
				<div className="tw-hidden tw-bg-[#932F2F] lg:tw-flex tw-flex-col tw-justify-around tw-items-center tw-w-[92%] tw-max-w-md tw-h-[75%] tw-rounded-br-lg tw-rounded-tr-lg">
