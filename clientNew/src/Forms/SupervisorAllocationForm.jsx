	...
	return (
		<>
			<section className="tw-m-5 tw-flex tw-justify-between">
				...
				<button
					className="tw-p-2 tw-px-5 tw-bg-white tw-text-black tw-rounded-md tw-shadow-md tw-border-2 tw-border-gray-400 hover:tw-bg-gray-500 hover:tw-text-white tw-duration-300"
			...
			<button
				className="tw-p-3 tw-px-7 tw-m-5 tw-bg-[#B22626] tw-text-white tw-rounded-md tw-shadow-md hover:tw-bg-gray-800 tw-duration-300"
				type="submit"
