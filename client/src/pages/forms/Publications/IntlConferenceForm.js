...
const IntlConferenceForm = () => {
  ...
  return (
    <section className='form-section'>
      ...
      <div className="form-group" onChange={(e)=>setConferencePlace(e.target.value)} required>
      ...
      <div className="form-group">
        ...
        <div>
          <label>
            <input type="radio" name="status-int-conference" value="accepted" onChange={(e) => setStatus(e.target.value)} required/> Accepted
          </label>
          <label>
            <input type="radio" name="status-int-conference" value="published" onChange={(e) => setStatus(e.target.value)} required/> Published
          </label>
          {/* <label>
            <input type="radio" name="status-int-conference" value="submitted" onChange={(e) => setStatus(e.target.value)} required/> Submitted
          </label> */}
        </div>
      </div>
      <div className="form-group">
...
export default IntlConferenceForm;
