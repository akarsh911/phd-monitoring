...
const DirectorSideListOfExaminer= ({ formData, handleHodRecommendationChange }) => {
  return (
    <div className='DoRDCSide-form'>
      <div className='data-input' id='appr'>
        <label htmlFor="hodRecommendation">Recommendation of Director</label>
        <div>
          <input
            type="radio"
            id="approved"
...
export default DirectorSideListOfExaminer;
