import './ThesisSub.css'; // Assuming this is your renamed CSS file
import React from 'react';

const SupervisorSideThesis = ({ formData, handleSupRecommendationChange }) => {
  return (
...
export default SupervisorSideThesis;
