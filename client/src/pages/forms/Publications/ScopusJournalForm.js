...
const ScopusJournalForm = () => {
  ...
  return (
    <section className='form-section'>
      ...
      <div className="form-group">
        <label>Page No.</label>
        <input type="text" value={volume} onChange={(e) => setPageNo(e.target.value)} required />
      </div>
      <div className="form-group">
      ...
      <div className="form-group">
        ...
        <div>
          <label>
            <input type="radio" name="status-scopus" value="accepted"  onChange={(e) => setStatus(e.target.value)} required/> Accepted
          </label>
          <label>
            <input type="radio" name="status-scopus" value="published"  onChange={(e) => setStatus(e.target.value)} required/> Published
          </label>
          {/* <label>
            <input type="radio" name="status-scopus" value="submitted"  onChange={(e) => setStatus(e.target.value)} required/> Submitted
          </label> */}
        </div>
      </div>
      <div className="form-group">
...
export default ScopusJournalForm;
